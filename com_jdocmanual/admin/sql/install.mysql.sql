...
INSERT INTO `#__jdocmanual_gfmindex` (`jdoc_key`, `manual`, `language`, `heading`, `filename`, `display_title`, `created`) VALUES
	('Help4.x:Components_Tags_Manager', 'help', 'en', 'components', 'components-tags-manager.md', 'Components Tags Manager', '2023-02-07 07:32:40') ON DUPLICATE KEY UPDATE id = id;
INSERT INTO `#__jdocmanual_gfmindex` (`jdoc_key`, `manual`, `language`, `heading`, `filename`, `display_title`, `created`) VALUES
...
INSERT INTO `#__jdocmanual_gfmindex` (`jdoc_key`, `manual`, `language`, `heading`, `filename`, `display_title`, `created`) VALUES 
	('Help4.x:Components_Tags_Manager', 'help', 'nl', 'components', 'components-tags-manager.md', 'Tags', '2023-02-11 14:13:49') ON DUPLICATE KEY UPDATE id = id;
INSERT INTO `#__jdocmanual_gfmindex` (`jdoc_key`, `manual`, `language`, `heading`, `filename`, `display_title`, `created`) VALUES 
