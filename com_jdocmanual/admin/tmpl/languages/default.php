...
$language_edit_route = 'index.php?option=com_jdocmanual&task=language.edit&id=';
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center">
                                    <?php echo HTMLHelper::_(
                                        'searchtools.sort',
                                        'COM_JDOCMANUAL_LANGUAGE_INDEX_LABEL',
                                        'a.index_language',
                                        $listDirn,
                                        $listOrder
                                    ); ?>
                                ...
                                <th scope="col" class="text-center">
                                    <?php echo HTMLHelper::_(
                                        'searchtools.sort',
                                        'COM_JDOCMANUAL_LANGUAGE_PAGE_LABEL',
                                        'a.page_language',
                                        $listDirn,
                                        $listOrder
                                    ); ?>
                        ...
                        foreach ($this->items as $i => $item) :
                            ...
                            <?php echo $states[$item->state]; ?>
                                ...
                                <td scope="row" class="has-context">
                                    <a href="<?php echo Route::_($language_edit_route . $item->id); ?>">
