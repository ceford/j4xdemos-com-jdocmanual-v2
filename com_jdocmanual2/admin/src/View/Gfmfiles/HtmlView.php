...
namespace J4xdemos\Component\Jdocmanual\Administrator\View\Gfmfiles;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title(Text::_('COM_JDOCMANUAL_GFMFILES'), 'code-branch');

		$toolbar->addNew('gfmfile.add');

		$toolbar->standardButton('gfm-update-html')
		->icon('fa fa-code')
		->text('COM_JDOCMANUAL_GFM_UPDATE_HTML')
		->task('gfmfiles.updatehtmlall')
		->onclick('return false')
		->listCheck(false);

		/*
		The number of records is the number of en records, which never changes!
		...
		*/
		...
		if ($tmpl !== 'component')
		{
			ToolbarHelper::help('gfmfiles', true);
		}
	}
}
